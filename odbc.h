...
#define CONNECTION_PARS "DRIVER=PostgreSQL ANSI;DATABASE=classicmodels;SERVER=localhost;PORT=5432;UID=postgres;PWD=/home/eps/Escritorio/odbc-examples/odbc-examples;"
